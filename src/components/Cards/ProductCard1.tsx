...
const ProductCard1 = ({ product }: ProductCardProps) => {
  ...
  return (
    <Link
      ...
      className="rounded-xl p-6 transition flex flex-col">
      {/* Image Section */}
      ...
      <div className="flex-[0.3] flex flex-col">
        <h3 className="text-lg font-semibold text-primaryColor-100 mb-2 line-clamp-2">
          {product.name}
        </h3>
        <div className="mt-auto">
          <p className="text-primaryColor-100 mb-4">
          ...
          <button
            ...
            className="w-full bg-tertiary-100 text-primaryColor-100 py-2 rounded-md transition"
