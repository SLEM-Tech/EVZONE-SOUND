...
const Footer = () => {
  ...
  const footer1socialMediaIcons = [
    {
      ...
      link: "http://facebook.com/evzone-sound/",
    ...
    // },
    {
      ...
      link: "http://instagram.com/evzone-sound/",
  ...
  return (
    <footer className=" w-full py-2 flex flex-col item-center border-t-[3px] border-primary">
