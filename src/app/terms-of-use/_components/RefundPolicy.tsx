  ...
  return (
    <div className="text-[#667085]">
      <h3 className="font-semibold text-sm md:text-base xl:text-lg mb-2">
        REFUND POLICY OF Evzone Sound Grid Com LIMITED
      </h3>
      ...
      <p className="text-xs md:text-sm xl:text-base mb-4">
        Customer satisfaction is our priority in Evzone Sound Grid Com LTD. This
        Refund Policy explains how we handle returns and refunds for purchases
        made through our e-commerce platform, with payments processed by any of
        our payment facilitators.
      </p>
      ...
      <ul className="list-disc pl-5 space-y-2 leading-[1.8] text-xs md:text-sm xl:text-base">
        ...
        <li>
          ...
          <ul className="list-disc pl-5 mt-1 space-y-1">
            <li>Email: info@evzone-sound.com.ng</li>
            <li>Phone: 09030954364</li>
            <li>Returns Page: https://www.evzone-sound.com.ng/</li>
          </ul>
