...
const Page = () => {
  ...
  return (
    <AppLayout className="pt-32">
      <main className="bg-background flex flex-col items-center relative justify-center w-full pt-40 slg:pt-44 xl:pt-5 mx-auto max-w-[1156px] min-h-[50vh] mb-20 px-4 lg:px-2">
        {ProductsTotal === 0 ? (
          <div className="">
