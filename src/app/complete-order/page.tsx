...
const Page = () => {
  ...
  return (
    <AppLayout className="px-16 sm:px-8">
      <main className="bg-background flex flex-col items-center relative justify-center w-full sm:py-10 pt-44 sm:pt-40 xl:py-5 mx-auto max-w-[1156px] min-h-[50vh] mb-20 px-8 lg:px-2">
